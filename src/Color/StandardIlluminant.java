...
public class StandardIlluminant {
    ...
    private static HashMap<Integer, Spectrum> blackbodies = new HashMap<>();
    private static HashMap<Integer, Spectrum> illuminantsD = new HashMap<>();
    ...
    public static final String STANDARD_ILLUMINANTS_ROOT = "/resources/StandardIlluminants/";
    ...
    public static TreeMap<Integer, Float> readSpectrumFromCSV(String filename, int wavelengthColumns, int valueColumn){
        TreeMap<Integer, Float> spectralData = new TreeMap<>();
        try {
            CSVReader csvReader = new CSVReader(new FileReader(Objects.requireNonNull(StandardIlluminant.class.getResource(filename)).getFile()));
